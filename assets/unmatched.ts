...
export const unmatched: Character[] = [
  ...
  },
  {
    ...
    ability: {
      en: "At the end of your turn, if there are no opposing fighters in Bigfoot's zone, you may draw 1 card.",
      es: 'Al final de tu turno, si no hay luchadores oponentes en la zona de Bigfoot, puedes robar 1 carta.',
    },
    amount: 30,
    cards: [
      {
  ...
  },
  {
    ...
    ability: {
      ...
      es: 'Después de que atacas, Deadpool recupera 1 de salud.\nAdemás, si el nombre real de tu oponente es Logan, todos tus ataques son +5.',
    },
    amount: 30,
  ...
  },
  {
    ...
    ability: {
      ...
      es: 'Las Raptors añaden 1 al valor de sus cartas de ataque por cada una de tus otras Raptors adyacentes al defensor.',
    },
    amount: 30,
  ...
  },
  {
    ...
    ability: {
      ...
      es: 'Los efectos en las cartas de HOLMES y DR. WATSON no pueden ser cancelados por un oponente.\n(Los efectos en las cartas de ANY pueden ser cancelados.)',
    },
  ...
  },
  {
    ...
    ability: {
      ...
      es: 'Al comienzo de tu turno, puedes recibir 1 de daño para invocar un Clon en un espacio vacío adyacente a Sun Wukong.\nNo comienzas con ningún Clon en el tablero.',
    },
    amount: 30,
  ...
  },
  {
    ...
    ability: {
      ...
      es: 'T-Rex es una luchadora grande. (Puede atacar hasta 2 espacios de distancia.) Al final de tu turno, toma una carta.\nLos luchadores grandes tienen una base extendida que puede ocupar hasta dos espacios. Los luchadores grandes pueden comenzar a moverse desde cualquier espacio en el que se encuentren. Cuando lo hacen, gíralos para que la cabeza se mueva al nuevo espacio. Su cola siempre sigue detrás de su cabeza, entrando en el espacio de la izquierda. Los luchadores grandes también ignoran las flechas de un solo sentido en los mapas y no pueden usar pasajes secretos.\nLos luchadores grandes pueden atacar hasta 2 espacios de distancia, incluso sobre luchadores que ocupan uno de esos espacios.',
    },
    amount: 30,
  ...
  {
    domain: 'Tales to Amaze',
    name: 'Mothman',
    amount: 30,
    image: require('assets/backs/mothman.jpg'),
    ability: {
      en: '',
      es: '',
    },
  ...
  },
  {
    ...
    amount: 30,
    image: require('assets/backs/martian.jpg'),
    ability: {
      en: '',
      es: '',
    },
